...
# static fields
.field public static final ACCEL_TEMP_FIELD:Ljava/lang/String; = "accelTemp"

.field public static final ACCEL_VALUES_FIELD:Ljava/lang/String; = "accelValues"
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    const-string p3, "ALTER TABLE glucoseReadings ADD COLUMN glucoseRaw1 INTEGER DEFAULT 0"

    .line 120
    invoke-virtual {p1, p3}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string p3, "ALTER TABLE glucoseReadings ADD COLUMN glucoseRaw2 INTEGER DEFAULT 0"

    .line 121
    invoke-virtual {p1, p3}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string p3, "ALTER TABLE glucoseReadings ADD COLUMN glucoseRaw3 INTEGER DEFAULT 0"

    .line 122
    invoke-virtual {p1, p3}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string p3, "ALTER TABLE glucoseReadings ADD COLUMN glucoseRaw4 INTEGER DEFAULT 0"

    .line 123
    invoke-virtual {p1, p3}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string p3, "ALTER TABLE glucoseReadings ADD COLUMN glucoseRaw5 INTEGER DEFAULT 0"

    .line 124
    invoke-virtual {p1, p3}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string p3, "ALTER TABLE glucoseReadings ADD COLUMN glucoseRaw6 INTEGER DEFAULT 0"

    .line 125
    invoke-virtual {p1, p3}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string p3, "ALTER TABLE glucoseReadings ADD COLUMN glucoseRaw7 INTEGER DEFAULT 0"

    .line 126
    invoke-virtual {p1, p3}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string p3, "ALTER TABLE glucoseReadings ADD COLUMN glucoseRaw8 INTEGER DEFAULT 0"
    ...
    const-string p2, "ALTER TABLE glucoseReadings ADD COLUMN accelValues INTEGER DEFAULT 0"

    .line 132
    invoke-virtual {p1, p2}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string p2, "ALTER TABLE glucoseReadings ADD COLUMN accelTemp INTEGER DEFAULT 0"
