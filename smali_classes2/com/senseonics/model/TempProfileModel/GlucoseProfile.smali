...
.method public toString()Ljava/lang/String;
    ...
    iget-boolean v2, p0, Lcom/senseonics/model/TempProfileModel/GlucoseProfile;->UsedAtLeastOnce_TargetHigh:Z

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v2, ") ; Target Low:"

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v2, p0, Lcom/senseonics/model/TempProfileModel/GlucoseProfile;->TargetLow:I
    ...
    iget-boolean v2, p0, Lcom/senseonics/model/TempProfileModel/GlucoseProfile;->UsedAtLeastOnce_TargetLow:Z

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v2, ") ; Alarm High:"

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v2, p0, Lcom/senseonics/model/TempProfileModel/GlucoseProfile;->AlarmHigh:I
    ...
    iget-boolean v2, p0, Lcom/senseonics/model/TempProfileModel/GlucoseProfile;->UsedAtLeastOnce_AlarmHigh:Z

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v2, ") ; Alarm Low:"

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v2, p0, Lcom/senseonics/model/TempProfileModel/GlucoseProfile;->AlarmLow:I
