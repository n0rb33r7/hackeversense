...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;

    const-string v3, "SEARCHING"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;->SEARCHING:Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;

    new-instance v3, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;

    const-string v5, "CONNECTING"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;->CONNECTING:Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;

    new-instance v5, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;

    const-string v7, "NEGOTIATING"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;->NEGOTIATING:Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;

    new-instance v7, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;

    const-string v9, "TRANSPORT_CONNECTED"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;->TRANSPORT_CONNECTED:Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;

    new-instance v9, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;

    const-string v11, "CONNECTED"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;->CONNECTED:Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;

    const/4 v11, 0x6

    new-array v11, v11, [Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;
    ...
    sput-object v11, Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;->$VALUES:[Lcom/senseonics/bluetoothle/BleHealthMonitor$BLE_CONNECTION_STATE;
