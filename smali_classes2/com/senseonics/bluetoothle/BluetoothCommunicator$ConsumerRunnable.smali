...
# direct methods
.method static bridge synthetic -$$Nest$fgetcanRetry(Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;)Z
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetcondition(Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;)Ljava/util/concurrent/locks/Condition;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetcurrentRequest(Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;)Lcom/senseonics/bluetoothle/Request;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgettheLock(Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;)Ljava/util/concurrent/locks/ReentrantLock;
    .locals 0
...
.method static bridge synthetic -$$Nest$fputcanRetry(Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;Z)V
    .locals 0
...
.method static bridge synthetic -$$Nest$msendCurrentRequest(Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;)V
    .locals 0
...
.method private sendCurrentRequest()V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/senseonics/bluetoothle/BluetoothCommunicator;->write(I[B)Z
...
.method public run()V
    ...
    const-string v2, "top of run loop"

    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 347
    iget-object v1, p0, Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;->this$0:Lcom/senseonics/bluetoothle/BluetoothCommunicator;

    invoke-static {v1}, Lcom/senseonics/bluetoothle/BluetoothCommunicator;->-$$Nest$fgetrequestBlockingSet(Lcom/senseonics/bluetoothle/BluetoothCommunicator;)Lcom/senseonics/bluetoothle/RequestBlockingSet;

    move-result-object v1

    invoke-virtual {v1}, Lcom/senseonics/bluetoothle/RequestBlockingSet;->blockingPeek()Lcom/senseonics/bluetoothle/Request;

    .line 348
    iget-object v1, p0, Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;->this$0:Lcom/senseonics/bluetoothle/BluetoothCommunicator;

    invoke-static {v1}, Lcom/senseonics/bluetoothle/BluetoothCommunicator;->-$$Nest$misConnected(Lcom/senseonics/bluetoothle/BluetoothCommunicator;)Z
    ...
    invoke-virtual {v1}, Lcom/senseonics/bluetoothle/RequestBlockingSet;->take()Lcom/senseonics/bluetoothle/Request;

    move-result-object v1

    iput-object v1, p0, Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;->currentRequest:Lcom/senseonics/bluetoothle/Request;
    ...
    const-string v3, "have request "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;->currentRequest:Lcom/senseonics/bluetoothle/Request;
    ...
    .line 354
    iput-boolean v1, p0, Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;->canRetry:Z

    .line 355
    invoke-direct {p0}, Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;->sendCurrentRequest()V

    .line 357
    iget-object v1, p0, Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;->condition:Ljava/util/concurrent/locks/Condition;
    ...
    iget-object v2, p0, Lcom/senseonics/bluetoothle/BluetoothCommunicator$ConsumerRunnable;->theLock:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    const-string v3, "not connected, so take a nap: "
