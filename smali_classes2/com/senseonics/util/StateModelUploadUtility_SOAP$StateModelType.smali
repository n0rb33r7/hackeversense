...
.method static constructor <clinit>()V
    ...
    .line 28
    new-instance v1, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;

    const-string v3, "StateModelType_SxInfo"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;->StateModelType_SxInfo:Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;

    .line 29
    new-instance v3, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;

    const-string v5, "StateModelType_ThresholdInfo"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;->StateModelType_ThresholdInfo:Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;

    .line 30
    new-instance v5, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;

    const-string v7, "StateModelType_AppInfo"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;->StateModelType_AppInfo:Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;

    .line 31
    new-instance v7, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;

    const-string v9, "StateModelType_CheckAndUpdatePassword"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;->StateModelType_CheckAndUpdatePassword:Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;
    ...
    .line 26
    sput-object v9, Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;->$VALUES:[Lcom/senseonics/util/StateModelUploadUtility_SOAP$StateModelType;
