...
.method public static createLogEventMenuDialog(Landroid/content/Context;Ljava/util/Calendar;)V
    ...
    invoke-direct {v6, v3, v7, v8}, Lcom/senseonics/view/DrawerMenu/MenuModel;-><init>(Ljava/lang/Object;Ljava/lang/String;I)V
    ...
    .line 65
    invoke-virtual {v8, v9, v3}, Landroid/os/Bundle;->putSerializable(Ljava/lang/String;Ljava/io/Serializable;)V

    const-string v3, "currentdate"

    .line 66
    invoke-virtual {v8, v3, p1}, Landroid/os/Bundle;->putSerializable(Ljava/lang/String;Ljava/io/Serializable;)V
    ...
    new-instance v3, Lcom/senseonics/util/AddEventMenuCreator$1;

    invoke-direct {v3, v0, p0, v8}, Lcom/senseonics/util/AddEventMenuCreator$1;-><init>(Landroid/app/Dialog;Landroid/content/Context;Landroid/os/Bundle;)V

    invoke-static {v4, p1, v3, v1, p0}, Lcom/senseonics/util/AddEventMenuCreator;->addView(Landroid/widget/LinearLayout;Lcom/senseonics/view/DrawerMenu/MenuModel;Landroid/view/View$OnClickListener;Landroid/view/LayoutInflater;Landroid/content/Context;)V
    ...
    check-cast v3, Lcom/senseonics/view/DrawerMenu/MenuModel;
    ...
    invoke-static {v4, v3, v6, v1, p0}, Lcom/senseonics/util/AddEventMenuCreator;->addView(Landroid/widget/LinearLayout;Lcom/senseonics/view/DrawerMenu/MenuModel;Landroid/view/View$OnClickListener;Landroid/view/LayoutInflater;Landroid/content/Context;)V
    ...
    invoke-static {v4, v3, v5, v1, p0}, Lcom/senseonics/util/AddEventMenuCreator;->addView(Landroid/widget/LinearLayout;Lcom/senseonics/view/DrawerMenu/MenuModel;Landroid/view/View$OnClickListener;Landroid/view/LayoutInflater;Landroid/content/Context;)V
