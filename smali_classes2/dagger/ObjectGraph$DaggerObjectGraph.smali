...
.method private getInjectableTypeBinding(Ljava/lang/ClassLoader;Ljava/lang/String;Ljava/lang/String;)Ldagger/internal/Binding;
    ...
    .line 308
    invoke-virtual {p2}, Ldagger/internal/Binding;->isLinked()Z
    ...
    invoke-virtual {p2}, Ldagger/internal/Linker;->linkRequested()V
    ...
    const-string p3, ". You must explicitly add it to the \'injects\' option in one of your modules."
...
.method static varargs makeGraph(Ldagger/ObjectGraph$DaggerObjectGraph;Ldagger/internal/Loader;[Ljava/lang/Object;)Ldagger/ObjectGraph;
    ...
    invoke-static {v0}, Ldagger/ObjectGraph$StandardBindings;->access$000(Ldagger/ObjectGraph$StandardBindings;)Ljava/util/List;
